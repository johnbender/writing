...
\trfrac[\rulelabel{e-if}]{
  ...
  \lit*{if false then} \ t \ \lit*{false else false} \rightarrow  \lit*{false}
}
\end{equation}
...
\trfrac[\rulelabel{e-app}]{
  \trfrac[\rulelabel{e-inv}]{}{\lambda \lambda \lit*{true} \lit*{()} \right \rightarrow \lambda \lit*{true}}
}{
  \lambda \lambda \lit*{true} \lit*{()} \ \lambda \lit*{false} \rightarrow \lit*{true}
}
\end{equation}
