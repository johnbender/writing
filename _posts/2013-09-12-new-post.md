...
Prior to joining Adobe though it was clear that none of these options fit me perfectly. The problems I gravitate towards are not normally assigned to engineers and y attempts to marry my interests with my domain of expertise [1,2] have resulted in understandably tepid responses. The ideas are hard to follow in short presentations, most people don't have time to read marathon blog posts, and only the presentations were funded by my employer, not the underlying work. All of that makes perfect sense but all of it means less time for the problems I'm interested in.
